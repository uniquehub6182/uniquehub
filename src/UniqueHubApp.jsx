...
html,body{font-family:'Figtree',sans-serif;background:#0D0D0D;margin:0;padding:0;height:100%;height:100dvh;color:${dark?"#E8EAED":"#192126"};overflow:hidden;overscroll-behavior:none;-webkit-overflow-scrolling:touch}#root{height:100%;height:100dvh;overflow:hidden;background:#0D0D0D}
input,textarea,select{font-size:16px !important}
.app{position:fixed;inset:0;max-width:430px;left:50%;transform:translateX(-50%);display:flex;flex-direction:column;overflow:hidden;background:${B.bg}}
.screen{position:fixed;inset:0;max-width:430px;left:50%;transform:translateX(-50%);display:flex;flex-direction:column;overflow:hidden;background:${B.bg}}
