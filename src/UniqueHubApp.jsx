...
html,body{font-family:'Figtree',sans-serif;background:${dark?"#1C2228":"#0D0D0D"};margin:0;padding:0;width:100%;height:100%;height:100dvh;color:${dark?"#E8EAED":"#192126"};overflow:hidden;overscroll-behavior:none;-webkit-overflow-scrolling:touch}#root{width:100%;height:100%;height:100dvh;overflow:hidden;background:${dark?"#1C2228":"#0D0D0D"}}
input,textarea,select{font-size:16px !important}
.app{width:100%;max-width:430px;margin:0 auto;height:100%;height:100dvh;display:flex;flex-direction:column;position:relative;overflow:hidden;background:${B.bg}}
.screen{width:100%;max-width:430px;margin:0 auto;height:100%;height:100dvh;display:flex;flex-direction:column;position:relative;overflow:hidden;background:${B.bg}}
.content{flex:1;overflow-y:auto;overflow-x:hidden;-webkit-overflow-scrolling:touch;overscroll-behavior-y:contain;scroll-behavior:smooth}
